...
def bat_classification():
    ...
    # Create optimizer
    optimizer = tf.compat.v1.train.MomentumOptimizer(learning_rate=learning_rate, momentum=0.005)
    # optimizer = tf.train.GradientDescentOptimizer(learning_rate=0.01)
    # optimizer = tf.train.MomentumOptimizer(learning_rate=0.01, momentum=0.005)
    
    # build a deep neural network
    # https://www.tensorflow.org/api_docs/python/tf/estimator/DNNClassifier
    classifier = tf.estimator.DNNClassifier(hidden_units = hidden_layers,feature_columns =feature_columns, n_classes = num_class,activation_fn = activation)
...
def mnist_classification():
    ...
    # build a deep neural network
    classifier = tf.estimator.DNNClassifier(hidden_units = hidden_layers,feature_columns =feature_columns,optimizer=optimizer, n_classes = num_class,activation_fn = activation)
